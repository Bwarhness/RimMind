...
namespace RimMind.Tools
{
    ...
    /// Validation tools → BuildingValidationTools
    /// Placement tools → this file (PlaceBuilding, PlaceStructure)
    /// </summary>
    public static class BuildingTools
    {
        ...
        public static string PlaceBuilding(JSONNode args)
        {
            ...
            foreach (var p in placements)
            {
                ...
                var materialCheck = BuildingValidationTools.CheckMaterials(map, def, stuff);
        ...
        // --- Forwarding stub for extracted material check (used internally) ---
        internal static MaterialCheckResult CheckMaterials(Map map, ThingDef buildingDef, ThingDef stuff)
            => BuildingValidationTools.CheckMaterials(map, buildingDef, stuff);
    }
}
